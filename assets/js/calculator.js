...
$('#assign_per').val(percent+'%'); 
	...
	if(total <= 0){
		$('#net_hourly').val('$ '+'0.00000000');
	}else{
		$('#net_hourly').val('$ '+( Number(total)).toFixed(8));
	}

if(total_day <= 0){
		$('#net_daily').val('$ '+'0.00000000');
	}else{
		$('#net_daily').val('$ '+(Number(total_day)).toFixed(8));
	}
	
if(total_weekly <= 0){
		$('#net_weekly').val('$ '+'0.00000000');
	}else{
		$('#net_weekly').val('$ '+ (Number(total_weekly)).toFixed(8));
	}
