...
class Admin extends Controller
{
	...
	public function index(){
		...
		$data['title'] = 'Dashboard | Bitsplash - Bitcoin Crypto Currency Investment Website';
	...
	public function users(){
		$session = session();
        $email = \config\Services::email();
		$data['title'] = 'Users | Bitsplash - Bitcoin Crypto Currency Investment Website';
		...
		if($this->request->getMethod() == 'post'){
            ...
            if(!$this->validate($rules)){
				...
				try{
                    ...
                    $reason = 'Update';
                    $message = 'Dear '.$this->request->getVar('name', FILTER_SANITIZE_STRING).',<br><br> Your Bitsplash trading account has been updated . <br><br> Kindly login to check new trading account update.<br>
                    <a href="'.base_url().'/login" target="_blank">Login Now
                    </a><br>Thanks, Bitsplash<br>';
	...
	public function profile(){
        $session = session();
        $email = \config\Services::email();
		$data['title'] = 'Profile | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
	...
	public function history(){
		$session = session();
        $email = \config\Services::email();
		$data['title'] = 'Transaction History | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
		$invested_model = new InvestedModel();
	...
	public function pendingWithdrawal(){
        $session = session();
        $email = \config\Services::email();
		$data['title'] = 'Pending Withdrawal | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
		$invested_model = new InvestedModel();
	...
	public function pendingDeposit(){
        $session = session();
        $email = \config\Services::email();
		$data['title'] = 'Pending Deposit | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
		$invested_model = new InvestedModel();
	...
	public function approvedDeposit(){
        $session = session();
        $email = \config\Services::email();
		$data['title'] = 'Approved Deposit | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
		$invested_model = new InvestedModel();
	...
	public function declinedDeposit(){
        $session = session();
        $email = \config\Services::email();
		$data['title'] = 'Declined Deposit | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
		$invested_model = new InvestedModel();
	...
	public function approvedWithdrawal(){
        $session = session();
        $email = \config\Services::email();
		$data['title'] = 'Approved Withdrawal | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
		$invested_model = new InvestedModel();
	...
	public function declinedWithdrawal(){
        $session = session();
        $email = \config\Services::email();
		$data['title'] = 'Declined Withdrawal | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
		$invested_model = new InvestedModel();
	...
	public function settings(){
        $session = session();
        $email = \config\Services::email();
		$data['title'] = 'Settings | Bitsplash - Bitcoin Crypto Currency Investment Website';
