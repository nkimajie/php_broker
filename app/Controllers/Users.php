...
class Users extends Controller
{
	...
	public function trade(){
		...
		$data['title'] = 'Live Trade | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
		$invested_model = new InvestedModel();
	...
	public function verify(){
		...
		$session = session();
        $email = \config\Services::email();
		$data['title'] = 'Verify Account | Bitsplash - Bitcoin Crypto Currency Investment Website';
	...
	public function deposit(){
		...
		$session = session();
        $email = \config\Services::email();
		$data['title'] = 'Deposit | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
	...
	public function withdrawal(){
		...
		$session = session();
        $email = \config\Services::email();
		$data['title'] = 'Withdrawal | Bitsplash - Bitcoin Crypto Currency Investment Website';
		$user_model = new UserModel();
		$plan_model = new PlanModel();
		$invested_model = new InvestedModel();
		$user = $user_model->getOne(array('uuid' => $session->user['uuid']));
