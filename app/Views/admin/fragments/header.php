      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="<?= base_url('admin') ?>" class="navbar-brand nav-link"><img alt="branding logo" src="<?= base_url('public/logo3.png') ?>" data-expand="<?= base_url('public/logo3.png') ?>" data-collapse="<?= base_url('public/logo3.png') ?>" class="brand-logo" style="width: 150px"></a></li>
